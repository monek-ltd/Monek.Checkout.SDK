...
import type { PaymentAuthorisationResult, PaymentVerificationResult } from './completion';
...
export type InitCallbacks = {
    ...
    onPaymentAuthorised?: (result: PaymentAuthorisationResult) => Promise<PaymentVerificationResult> | PaymentVerificationResult;
}
